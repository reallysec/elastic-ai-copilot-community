...
import { ArrowRight01Icon, CornerDownRightIcon, Copy01Icon, ArrowDataTransferHorizontalIcon, Layers01Icon, SlidersHorizontalIcon, Delete02Icon, Cancel01Icon, MoreVerticalIcon } from "@hugeicons/core-free-icons"
...
function FilterPathSeparator() {
  return (
    <HugeiconsIcon icon={ArrowRight01Icon} strokeWidth={2} aria-hidden="true" data-slot="filter-path-separator" className="text-muted-foreground mx-[3px] inline-block size-3 shrink-0 self-center align-[calc(0.3635em_-_0.375rem)]" />
  )
}
    ...
    <>
      {destinations.map((destination) => (
        ...
        >
          ...
          <HugeiconsIcon icon={CornerDownRightIcon} strokeWidth={2} aria-hidden="true" />
  ...
  return (
    ...
    <>
      ...
      >
        ...
        <HugeiconsIcon icon={ArrowDataTransferHorizontalIcon} strokeWidth={2} aria-hidden="true" />
