...
import { RefreshIcon, Alert02Icon, DragDropVerticalIcon, ArrowDown01Icon, MoreVerticalIcon, Cancel01Icon, PlusSignIcon, Copy01Icon, UngroupItemsIcon, Delete02Icon, FilterMailIcon, FolderAddIcon } from "@hugeicons/core-free-icons"
    ...
    >
      ...
      >
        ...
        >
          ...
          <HugeiconsIcon icon={UngroupItemsIcon} strokeWidth={2} aria-hidden="true" />
          <span className={FILTER_MENU_LABEL_CLASS}>
