...
function CodeBlockLanguage({
  ...
  return (
    <span
      ...
      className={cn(
        "border-border bg-muted/60 text-muted-foreground inline-flex shrink-0 items-center rounded-md border px-1.5 py-0.5 font-mono text-11 leading-none uppercase",
        className
      )}
      {...props}
    >
